...
if __name__ == '__main__':
    ...
    parser.add_argument('--obj', type=str, default="table", help='tranining dataset object category')
    ...
    parser.add_argument('--data_dir', type=str, default='/table/', help='dataset load path')
