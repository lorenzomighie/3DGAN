...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_thresh', type=float, default=0.8, help='for balance dsicriminator and generator')
    parser.add_argument('--z_size', type=float, default=200, help='latent space size')
    ...
    parser.add_argument('--obj', type=str, default="monitor", help='tranining dataset object category')
    ...
    parser.add_argument('--data_dir', type=str, default='/monitor/', help='dataset load path')
    ...
    parser.add_argument('--model_name', type=str, default="V2",
                        help='this model name for save pickle, logs, output image path and if '
                             'model_name contain V2 modelV2 excute')
    parser.add_argument('--use_tensorboard', type=str2bool, default=True, help='using tensorboard logging')
    parser.add_argument('--test_iter', type=int, default=10, help='test_epoch number')
    parser.add_argument('--test', type=str2bool, default=False, help='for test')
