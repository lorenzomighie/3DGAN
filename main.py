...
if __name__ == '__main__':
    ...
    parser.add_argument('--obj', type=str, default="sofa", help='tranining dataset object category')
    ...
    parser.add_argument('--data_dir', type=str, default='/sofa/', help='dataset load path')
